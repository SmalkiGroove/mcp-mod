...
BuilderGroup {
    ...
    Builder {
        ...
        Priority = 75,
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 5, categories.STRUCTURE * categories.ENERGYPRODUCTION * categories.TECH3 } },
    ...
    Builder {
        ...
        Priority = 50,
        BuilderConditions = {
            { UCBC, 'HaveGreaterThanUnitsWithCategory', { 5, categories.STRUCTURE * categories.MASSFABRICATION * categories.TECH3 } },
