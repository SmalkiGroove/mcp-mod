...
local SeraHeavyLightningCannonChildProjectile = import('/mods/MCP/lua/MCPProjectiles.lua').SeraHeavyLightningCannonChildProjectile
local EffectTemplate = import('/lua/EffectTemplates.lua')
local RandomFloat = import('/lua/utilities.lua').GetRandomFloat
local utilities = import('/lua/utilities.lua')

SeraHeavyLightningCannonChild01 = Class(SeraHeavyLightningCannonChildProjectile) {
    AttackBeams = {'/mods/MCP/effects/emitters/seraphim_lightning_beam_02_emit.bp'},
    FxBeam = {'/mods/MCP/effects/emitters/seraphim_lightning_beam_02_emit.bp'},
    FxBeamScale = 0.01,
