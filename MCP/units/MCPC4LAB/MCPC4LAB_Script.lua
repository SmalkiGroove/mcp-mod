...
MCPC4LAB = Class(CWalkingLandUnit) {
    ...
    CreateHeadConvectionSpinners = function(self)
        ...
        for i = 0, (sides-1) do
            ...
            local proj = self:CreateProjectile('/mods/MCP/effects/entities/BasiliskNukeEffect03/BasiliskNukeEffect03_proj.bp', x, HeightOffset, z, x, 0, z)
    ...
    CreateBlueFireDamageEffects = function(self, bone, army)
        for k, v in MCPEffectTemplate.DamageBlueFire do
    ...
    DeathThread = function(self)
       ...
       WaitSeconds(1)
        ...
        self:CreateProjectile('/mods/MCP/effects/entities/BasiliskNukeEffect01/BasiliskNukeEffect01_proj.bp',0,FireballDomeYOffset,0,0,0,1)
