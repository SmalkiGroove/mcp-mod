...
local StunZapperWeapon = import('/mods/MCP/lua/MCPWeapons.lua').StunZapperWeapon

MCPC3BPD = Class(CRadarUnit) { 
    ChargeEffects01 = {
        '/mods/MCP/effects/emitters/manticore_charge_laser_flash_01_emit.bp',  --glow
        '/mods/MCP/effects/emitters/manticore_charge_laser_muzzle_01_emit.bp',  -- sparks
    },
        ...
        Turret01 = Class(StunZapperWeapon) {            
            ...
            StunZapperWeapon.PlayFxRackSalvoChargeSequence(self, muzzle) 
                ...
                if self.unit.BeamChargeEffects then
                    ...
                    table.insert(self.unit.BeamChargeEffects, AttachBeamEntityToEntity(self.unit, 'FocusBeam01_start', self.unit, 'FocusBeam01_end', self.unit:GetArmy(), '/mods/MCP/effects/emitters/manticore_charge_beam_01_emit.bp'))
                    table.insert(self.unit.BeamChargeEffects, AttachBeamEntityToEntity(self.unit, 'FocusBeam02_start', self.unit, 'FocusBeam02_end', self.unit:GetArmy(), '/mods/MCP/effects/emitters/manticore_charge_beam_01_emit.bp'))
