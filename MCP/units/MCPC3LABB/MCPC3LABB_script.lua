...
MCPC3LABB = Class(CWalkingLandUnit) {
    WalkingAnimRate = 1,

    Weapons = {
        HeavyDisintigrator01 = Class(CDFLaserDisintegratorWeapon) {},
        DisintigratorPod01 = Class(CDFLaserDisintegratorWeapon) {},
        MissilePod01 = Class(CAAMissileNaniteWeapon) {},
        MissilePod02 = Class(CAAMissileNaniteWeapon) {},
    },
...
#	            self:SetWeaponEnabledByLabel('Torpedo', true)
    ...
    DeathThread = function(self)
        ...
        explosion.CreateFlash( self, 'Torso', 4.5, army )
        ...
        CreateDeathExplosion( self, 'L_Arm_B01', 1.5)
        self:CreateDamageEffects( 'L_Arm_Barrel', army )
        self:CreateDamageEffects( 'L_Arm_Recoil01', army )
        ...
        CreateDeathExplosion( self, 'R_Arm_Barrel', 1)
        for k, v in EffectTemplate.FootFall01 do
            CreateAttachedEmitter(self,'R_Arm_B01',army, v):ScaleEmitter(1)          
            CreateAttachedEmitter(self,'R_Arm_Recoil01',army, v):ScaleEmitter(1) 
        end
        ...
        CreateDeathExplosion( self, 'L_Arm_Muzzle01', 2)
        self:CreateFirePlumes( army, {'L_Arm_Muzzle01'}, -1 )
        self:CreateDamageEffects( 'R_Arm_B01', army )
        WaitSeconds(0.5)
        
        CreateDeathExplosion( self, 'Left_Leg0' .. Random(1,3) .. '_B0' .. Random(1,3), 0.25)
        self:CreateDamageEffects( 'Right_Leg01_B03', army )
        WaitSeconds(0.5)
        CreateDeathExplosion( self, 'L_Arm_Barrel', 1)
        self:CreateExplosionDebris( army )
        ...
        CreateDeathExplosion( self, 'Left_Leg0' .. Random(1,3) .. '_B0' .. Random(1,3), 0.25)
        CreateDeathExplosion( self, 'L_Arm_B01', 2 )
