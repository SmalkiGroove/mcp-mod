...
MCPS4LXAB = Class(SWalkingLandUnit) {
    ...
    Weapons = {
		...
		Upgrade02Gun01 = Class(SDFSihEnergyRifleNormalMode) {},
		Upgrade02Gun02 = Class(SDFSihEnergyRifleNormalMode) {},
		Upgrade03Gun01 = Class(SDFSihEnergyRifleNormalMode) {},
		Upgrade03Gun02 = Class(SDFSihEnergyRifleNormalMode) {},
		Upgrade04Gun01 = Class(SDFSihEnergyRifleNormalMode) {},
		Upgrade04Gun02 = Class(SDFSihEnergyRifleNormalMode) {},
    },
    ...
    DeathThread = function( self, overkillRatio , instigator)
        ...
        # since projectile rotation and terrain collision doesnt work that great. These are left in
